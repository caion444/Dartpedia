...
Future<void> searchWikipedia(
  ...
  try {
    ...
    logger.info(
      'Busca realizada com sucesso: $articleTitle',
    );
...
dart run bin/cli.dart wikipedia Flutter
